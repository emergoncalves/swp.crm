...
export default function Index({ contacts, filters }) {
    ...
    return (
        <AuthenticatedLayout header="Contatos">
            <Head title="Contatos" />
            ...
            <div className="crm-page-header">
                ...
                <Link href={route('contacts.create')} className="crm-btn-primary">
                        ...
                        <tbody>
                            {contacts.data.map((contact) => (
                                <tr key={contact.id}>
                                    ...
                                    <td className="text-slate-600">{contact.company?.name || '-'}</td>
                                    <td>
                                            ...
                                            <button
                                                onClick={() => {
                                                    if (confirm('Tem certeza que deseja excluir este contato?')) {
                                                        router.delete(route('contacts.destroy', contact));
                                                    }
                                                }}
